...
popular_hashtags = set(
    ...
    "BiometricDataProtection", 
    "DataGovernance", 
    "CyberInsurance", 
    "PrivacyComplianceTools", 
    "DSARTools", 
    "DataEncryption", 
    "SecureFileTransfer", 
    "MobileDevicePrivacy", 
    ...
    "PrivateSearchEngines", 
    "PrivacyFocusedOperatingSystems", 
    "PrivacyCentricSocialNetworks", 
    "BlockchainForPrivacy", 
    "SecureCloudStorage", 
    "PrivacyFilters", 
    "RFIDBlocking", 
    "WebcamCovers", 
    "Mic-Lock", 
    "PrivacyScreenProtectors"
    "iPhone", 
    "iPad", 
    "MacBook", 
    "AppleWatch", 
